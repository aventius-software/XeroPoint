...
class XeroPoint_Test_Resource_Script extends PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		parent::setUp ();
		$this->testObject = new XeroPoint_Resource_Script ( self::TEST_RESOURCE_NAME );
	}
